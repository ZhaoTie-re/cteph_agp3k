...
# ------------------------------------------------------------------------------
# 输入文件路径
sum_path <- '/LARGE0/gr10478/b37974/Pulmonary_Hypertension/cteph_agp3k/review_analysis/06.regional_plot_rev1/eas_ld/chr16_53887925_T_C.eas_ld_sum_stat.tsv'
...
# 目标 SNP
target_snp <- c("chr16:53887925:T:C")
