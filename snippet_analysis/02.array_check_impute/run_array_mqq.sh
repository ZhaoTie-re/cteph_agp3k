#!/bin/bash
#SBATCH --job-name=array_mqq
#SBATCH -p gr10478b
#SBATCH -t 168:0:0
#SBATCH --rsc p=1:t=16:c=8:m=36568M
#SBATCH --output=array_mqq_%j.log
#SBATCH --error=array_mqq_%j.err

# 设置工作目录
cd /LARGE0/gr10478/b37974/Pulmonary_Hypertension/cteph_agp3k/snippet_analysis/02.array_check_impute

# 激活conda环境
source activate gwaslab

# 创建Python脚本
cat > run_array_mqq.py << 'EOF'
import pandas as pd
import numpy as np
