params.wgsDir = "/LARGE0/gr10478/b37974/Pulmonary_Hypertension/cteph_agp3k.v5/wgs/results/03.af_gtnorm"
params.arrayDir = "/LARGE0/gr10478/b37974/Pulmonary_Hypertension/cteph_agp3k.v5/array/results/14.final_vcf"
params.infoDir = "/LARGE0/gr10478/b37974/Pulmonary_Hypertension/cteph_agp3k.v5/tuning.concordance.v5/info"
params.scriptDir = "/LARGE0/gr10478/b37974/Pulmonary_Hypertension/cteph_agp3k.v5/tuning.concordance.v5/scripts"
params.outDir = "/LARGE0/gr10478/b37974/Pulmonary_Hypertension/cteph_agp3k.v5/tuning.concordance.v5/results"
...
process FormatMatrixPrepare {
    ...
    call_prefix = "wgs"
    true_prefix = "array"
    call_vcf = "${wgsDir}/${chr}.vqc.af.gtnorm.vcf.gz"
    call_vcf_tbi = "${wgsDir}/${chr}.vqc.af.gtnorm.vcf.gz.tbi"
    true_vcf = "${arrayDir}/cteph_agp3k.array.sqc.vqc.tommo.tommo.vcf.gz"
    true_vcf_tbi = "${arrayDir}/cteph_agp3k.array.sqc.vqc.tommo.tommo.vcf.gz.tbi"
    """
...
process ConcordanceVmissCalculator {
    ...
    script:
    sample_info = "${infoDir}/jhrpv5.target_dp.csv"
    """
    source activate cteph_geno_pro
